...
import subprocess
from Amazon_SocialEmodel_sage_IndP_IndGrowth import StickyEmarkovConsumerType, StickyEmarkovRepAgent, StickyCobbDouglasMarkovEconomy
from ConsAggShockModel import SmallOpenMarkovEconomy
from HARKutilities import plotFuncs
import matplotlib.pyplot as plt
import scipy as sp
import Amazon_SocialEparams as Params
...
#        print('Solving the small open Markov economy took ' + mystr(t_end-t_start) + ' seconds.')
        ...
        name = 'SOEmarkovSocial_'+str(Min_siz)+'_'+str(Max_siz)
...
#############################################################
    ...
    C_std=np.array(C_std)**2
    print('Minimum Size of Network '+str(Min_siz))
    print('Maximum Size of Network '+str(Max_siz))
    print('variance of Aggregate Consumption:')
    print(C_std)
    print('variance of Individual Consumptiono:')
    print(c_std)
    Name_Agg='\Aggregate_C'+'_Min_'+str(Min_siz)+'_Max_'+str(Max_siz)+'.txt'
    Name_Ind='\Individual_c'+'_Min_'+str(Min_siz)+'_Max_'+str(Max_siz)+'.txt'
...
#0.00027186629755426774 Agg size=1